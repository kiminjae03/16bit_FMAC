...
int main()
{
    ...
    printf(BLUE  "##  MULTIPLIER NORMAL GRS                VERSION : %s  ##\n" RESET, _MULTI_NORMAL_GRS_VERSION_);
    printf(CYAN  "################################################################\n\n" RESET);
    // fprintf(output_file, "\n");
    fprintf(output_file, "################################################################\n");
    fprintf(output_file, "##  FLOATING POINT                                            ##\n");
    fprintf(output_file, "##  MULTIPLIER NORMAL GRS                VERSION : %s  ##\n", _MULTI_NORMAL_GRS_VERSION_);
    fprintf(output_file, "################################################################\n\n");
