...
int main()
{
    ...
    strftime(output_filename, sizeof(output_filename), "02_add_denormal_grs_output_%y%m%d_%H%M%S_.txt", t);
    ...
    printf(BLUE  "##  ADDER DENORMAL GRS                   VERSION : %s  ##\n" RESET, _ADDER_DENORMAL_GRS_VERSION_);
    printf(CYAN  "################################################################\n\n" RESET);
    // fprintf(output_file, "\n");
    fprintf(output_file, "################################################################\n");
    fprintf(output_file, "##  FLOATING POINT                                            ##\n");
    fprintf(output_file, "##  ADDER DENORMAL GRS                   VERSION : %s  ##\n", _ADDER_DENORMAL_GRS_VERSION_);
    fprintf(output_file, "################################################################\n\n");

    for(int i=0; i<46571; i++) {
    // for(int i=0; i<10; i++) {
