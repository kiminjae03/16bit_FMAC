...
int main()
{
    ...
    strftime(output_filename, sizeof(output_filename), "02_add_output_%y%m%d_%H%M%S_.txt", t);
    ...
    printf(BLUE  "##  ADDER                 VERSION : %s  ##\n" RESET, _ADDER_VERSION_);
    printf(CYAN  "#################################################\n\n" RESET);
    // fprintf(output_file, "\n");
    fprintf(output_file, "#################################################\n");
    fprintf(output_file, "##  FLOATING POINT                             ##\n");
    fprintf(output_file, "##  ADDER                 VERSION : %s  ##\n", _ADDER_VERSION_);
    fprintf(output_file, "#################################################\n\n");
